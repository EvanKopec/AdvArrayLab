...
function findCuisineType(){
    let cuisineType = prompt("What cuisine type do you want to find?")
    let results = dishes.filter(
        function(el){
...
function findItalianWithServing(){
    let results = dishes.filter(
        function(el){
...
function findIdMatchingServing(){
    let results = dishes.filter(
        function(el){
...
let cuisineArry = typesOfCuisine();
console.log(cuisineArry);
//9. Create a function that will return an array of strings, with the cuisine type appended to the start of the dish's name. Ie, ["Italian Pizza", "Italian Spaghetti", ...]
//Map 

function nameAndTypeFood(){
    let results = dishes.map(
        function(el){
...
let fullDishName = nameAndTypeFood()
console.log(fullDishName)
//10. Create a function that will use advanced array methods on the 'dishes' array and return the result ["Vegetarian Lasagna", "Vegetarian Falafel", "Vegetarian Chili"]

function onlyVegetarianFood(){
    let fullDishName = nameAndTypeFood();
    let vegetarianDishes = fullDishName.filter(
        function(el){
            if(el.charAt(0) == "V"){
                return true;
            }
